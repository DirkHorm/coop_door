...
class Config:
    ...
    def get_coop_door_buttons_pins(self) -> dict[str, int]:
        return {
            "open": int(self.config["COOP_DOOR_BUTTONS"]["open_btn_pin"]),
            "stop": int(self.config["COOP_DOOR_BUTTONS"]["stop_btn_pin"]),
            "close": int(self.config["COOP_DOOR_BUTTONS"]["close_btn_pin"])
        }
